...
// [version: v1.0.2]
// [title: 摸鱼]
// [description: 显示节假日倒计时，定时推送群设置：set otto moyv_push_groups qqgroup:123,wxgroup:456,tggroup:-100123]
// [platform: qq,wx,tg]
// [public: false]
// [price: 0.01]
//=========================================================
...
var msg = '';
var festivals = [];//var festivals = new Array();
...
function main() {
    try {
        ...
        msg += request("http://bjb.yunwj.top/php/mo-yu/php.php").replace("！", "！\n").replace(",", "，").replace("?", "").replace(/:/g, "").replace("自己的", "自己的。\n").replace("上班是", "\n上班是").replace(/<br\/>/g, "\n").replace("...", "！")
    } catch (e) {
        headInfo();
        weekend();
