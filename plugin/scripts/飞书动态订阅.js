...
//[price: 2] 上架价格
//[description: 用于更新飞书订阅方式请求地址，如：飞书订阅 https://www.autman.com:8080。配合 cpolar 实现动态更新<br>首发：20240629<br><img src="https://bbs.autman.cn/assets/files/2024-07-01/1719799198-543594-92dba2d8-48f1-4830-a696-35f78228cb56.jpg" alt="飞书动态订阅" />] 使用方法尽量写具体
...
!(async () => {
    ...
    let app_id = await middleware.bucketGet("fs", "app_id"),
        ...
        message = `${plugin_name} v${plugin_version}\n========================\nAPP ID: ${app_id}\n请求地址: ${verificationUrl}\n`,
        response
